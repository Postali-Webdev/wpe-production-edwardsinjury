                    ...
                    <div class="posts-categories">
                        ...
                        <?php if ($categories): ?>
                            ...
                            <?php foreach ($categories as $category): ?>
                                <span class="post-categories__button <?php echo ($counter == 0) ? 'post-categories__button-active' : '' ?>  "
                                      data-category="<?php echo $category->slug; ?>"><?php echo $category->name; ?></span>
                                <?php $counter++; ?>
                            <?php endforeach; ?>
                        <?php endif; ?>
                    </div>

                    <div class="cell announcement-wrapper">
                        ...
                        if ($wp_query->have_posts()) : ?>
                            <div class="faqs-list  announcement-list " data-cat="successes">
                        ...
                        if ($wp_query->have_posts()) : ?>
                            <div class="faqs-list  announcement-list announcement-list-active" data-cat="news">
                                <?php while ($wp_query->have_posts()) : $wp_query->the_post(); ?>
