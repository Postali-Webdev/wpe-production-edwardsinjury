...
function genesis_sample_enqueue_scripts_styles()
{
    ...
    wp_enqueue_style('genesis-sample-fonts', 'https://use.typekit.net/pze8xxk.css', array(), CHILD_THEME_VERSION);
    ...
    wp_enqueue_style('slick-css', get_stylesheet_directory_uri() . '/css/css/plugins/slick.css', array());
    wp_enqueue_style('slick-theme-css', get_stylesheet_directory_uri() . '/css/css/plugins/slick-theme.css', array());
    ...
    wp_enqueue_script('slick-js', get_stylesheet_directory_uri() . '/js/plugins/slick.min.js', null, '1.0', true);
            ...
            <div class="grid-container">
                <div class="grid-x grid-margin-x">
                    ...
                    <div class="cell large-5 medium-6 large-offset-1 medium-order-1 text-left footer__content-container">
                        ...
                        <?php endif; ?>
                        <!--                        --><?php //if ($link_consult = get_field('book_a_consultation', 'option')): ?>
                        <!--                            <a  class="consult_link consult_link-home" href="-->
                        <?php //echo esc_url($link_consult['url']); ?><!--"-->
                        <!--                               target="-->
                        <?php //echo esc_attr($link_consult['target'] ? $link_consult['target'] : '_self'); ?><!--">-->
                        <?php //echo esc_html($link_consult['title']); ?><!--</a>-->
                        <!--                        --><?php //endif; ?>
                        <?php if (get_field('address_link', 'option') || get_field('address_text', 'option')):
                            ...
                            <a href="<?php echo get_field('address_link', 'option') ?>" target="_blank" class="footer__address footer__address-home"><?php echo $text ?></a>
                            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d4210.566619116271!2d-80.83006759999999!3d35.211611999999995!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x88569f71134c2b4b%3A0xcc342e2e3c970d25!2sEdwards%20Injury%20Law!5e1!3m2!1sen!2sus!4v1761592051045!5m2!1sen!2sus" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                        <?php endif; ?>
            ...
            <div class="grid-container footer__single-page-content">
                <div class="grid-x grid-padding-x align-middle">
                    <div class="cell large-4 medium-12  text-left footer__single-page-address">
                        <?php if ($link_consult = get_field('book_a_consultation', 'option')): ?>
                            <a class="consult_link " href="<?php echo esc_url($link_consult['url']); ?>"
                               target="<?php echo esc_attr($link_consult['target'] ? $link_consult['target'] : '_self'); ?>"><?php echo esc_html($link_consult['title']); ?></a>
                        <?php endif; ?>
                        <?php if (get_field('address_link', 'option') || get_field('address_text', 'option')):
                            $text = get_field('address_text', 'option') ? get_field('address_text', 'option') : 'Address'; ?>
...
function gngf_filter_get_announcement($taxonomy)
{
    ...
    $paged = !empty($paged) ? (int)$paged : 1;
    $category = !empty($category) && $category != '-1' ? array(
        'taxonomy' => 'success_categories',                //(string) - Taxonomy.
        'field' => 'slug',                    //(string) - Select taxonomy term by ('id' or 'slug')
        'terms' => $category,    //(int/string/array) - Taxonomy term(s).
    ) : '';
    ...
    if ($wp_query->have_posts()) : ?>
        <?php while ($wp_query->have_posts()) : $wp_query->the_post();
            ...
            if ($current_cat_slug == 'successes') :
                get_template_part('parts/announcement/category-successes');
            else :

                get_template_part('parts/announcement/announcement-item');
            endif;
        endwhile; ?>
        <?php
        $paginateArgs = array(
...
add_action('wp_ajax_filter_announcement', 'gngf_filter_get_announcement');
add_action('wp_ajax_nopriv_filter_announcement', 'gngf_filter_get_announcement');
...
//Changing breadcrumbs on single team
...
function display_oembed($iframe)
{
